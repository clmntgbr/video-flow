...
class DebugController extends AbstractController
{
    ...
    public function subtitleGeneratorApi(#[CurrentUser] ?User $user, EntityManagerInterface $entityManager, MediaPodRepository $mediaPodRepository, FilesystemOperator $awsStorage, MessageBusInterface $messageBus): JsonResponse
    {
        ...
        $path = sprintf('%s/%s/%s', $user->getUuid(), $mediaPod->getUuid(), 'ddece7e95695595e8b6147b7a3127553.mp4');
        $stream = fopen('/app/public/debug/ddece7e95695595e8b6147b7a3127553.mp4', 'r');
        ...
        $path = sprintf('%s/%s/audios/%s', $user->getUuid(), $mediaPod->getUuid(), 'ddece7e95695595e8b6147b7a3127553_1.wav');
        $stream = fopen('/app/public/debug/audios/ddece7e95695595e8b6147b7a3127553_1.wav', 'r');
        $awsStorage->writeStream($path, $stream, [
            'visibility' => 'public',
        ]);

        $path = sprintf('%s/%s/audios/%s', $user->getUuid(), $mediaPod->getUuid(), 'ddece7e95695595e8b6147b7a3127553_2.wav');
        $stream = fopen('/app/public/debug/audios/ddece7e95695595e8b6147b7a3127553_2.wav', 'r');
        $awsStorage->writeStream($path, $stream, [
            'visibility' => 'public',
        ]);

        $path = sprintf('%s/%s/audios/%s', $user->getUuid(), $mediaPod->getUuid(), 'ddece7e95695595e8b6147b7a3127553_3.wav');
        $stream = fopen('/app/public/debug/audios/ddece7e95695595e8b6147b7a3127553_3.wav', 'r');
        $awsStorage->writeStream($path, $stream, [
            'visibility' => 'public',
        ]);

        $path = sprintf('%s/%s/audios/%s', $user->getUuid(), $mediaPod->getUuid(), 'ddece7e95695595e8b6147b7a3127553_4.wav');
        $stream = fopen('/app/public/debug/audios/ddece7e95695595e8b6147b7a3127553_4.wav', 'r');
        $awsStorage->writeStream($path, $stream, [
            'visibility' => 'public',
        ]);

        $path = sprintf('%s/%s/audios/%s', $user->getUuid(), $mediaPod->getUuid(), 'ddece7e95695595e8b6147b7a3127553_5.wav');
        $stream = fopen('/app/public/debug/audios/ddece7e95695595e8b6147b7a3127553_5.wav', 'r');
        $awsStorage->writeStream($path, $stream, [
            'visibility' => 'public',
        ]);
        ...
        $path = sprintf('%s/%s/subtitles/%s', $user->getUuid(), $mediaPod->getUuid(), 'ddece7e95695595e8b6147b7a3127553_1.srt');
        $stream = fopen('/app/public/debug/subtitles/ddece7e95695595e8b6147b7a3127553_1.srt', 'r');
        $awsStorage->writeStream($path, $stream, [
            'visibility' => 'public',
        ]);

        $path = sprintf('%s/%s/subtitles/%s', $user->getUuid(), $mediaPod->getUuid(), 'ddece7e95695595e8b6147b7a3127553_2.srt');
        $stream = fopen('/app/public/debug/subtitles/ddece7e95695595e8b6147b7a3127553_2.srt', 'r');
        $awsStorage->writeStream($path, $stream, [
            'visibility' => 'public',
        ]);

        $path = sprintf('%s/%s/subtitles/%s', $user->getUuid(), $mediaPod->getUuid(), 'ddece7e95695595e8b6147b7a3127553_3.srt');
        $stream = fopen('/app/public/debug/subtitles/ddece7e95695595e8b6147b7a3127553_3.srt', 'r');
        $awsStorage->writeStream($path, $stream, [
            'visibility' => 'public',
        ]);

        $path = sprintf('%s/%s/subtitles/%s', $user->getUuid(), $mediaPod->getUuid(), 'ddece7e95695595e8b6147b7a3127553_4.srt');
        $stream = fopen('/app/public/debug/subtitles/ddece7e95695595e8b6147b7a3127553_4.srt', 'r');
        $awsStorage->writeStream($path, $stream, [
            'visibility' => 'public',
        ]);

        $path = sprintf('%s/%s/subtitles/%s', $user->getUuid(), $mediaPod->getUuid(), 'ddece7e95695595e8b6147b7a3127553_5.srt');
        $stream = fopen('/app/public/debug/subtitles/ddece7e95695595e8b6147b7a3127553_5.srt', 'r');
        $awsStorage->writeStream($path, $stream, [
            'visibility' => 'public',
        ]);
        ...
        $protoVideo->setSubtitles([
            'ddece7e95695595e8b6147b7a3127553_1.srt',
            'ddece7e95695595e8b6147b7a3127553_2.srt',
            'ddece7e95695595e8b6147b7a3127553_3.srt',
            'ddece7e95695595e8b6147b7a3127553_4.srt',
            'ddece7e95695595e8b6147b7a3127553_5.srt',
        ]);
